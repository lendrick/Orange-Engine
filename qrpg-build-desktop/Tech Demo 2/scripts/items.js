...
// Item definitions
{
  ...
  items['Staff'].atk = 8;
  items['Staff'].portrait = rpgx.projectDir() + "/images/icons/W_Mace011.png";

  items['Dagger'] = newCharacter('Dagger');
  items['Dagger'].setTypes(Array('weapon', 'metal', 'small', 'piercing', '1handed'));
  items['Dagger'].atk = 5;
  items['Dagger'].portrait = rpgx.projectDir() + "/images/icons/W_Dagger001.png";
  ...
  items['Leather Armor'].portrait = rpgx.projectDir() + "/images/icons/A_Armour01.png";
  ...
  items['Wizard Robe'].portrait = rpgx.projectDir() + "/images/icons/A_Clothing01.png";
  ...
  items['Wizard Hat'].portrait = rpgx.projectDir() + "/images/icons/C_Hat01.png";

  item = newCharacter('Potion');
  item.setTypes(Array('consumable', 'hp+'));
  item.useAbility = 'CurePotion';
  item.portrait = rpgx.projectDir() + "/images/icons/P_Red01.png";
  items['Potion'] = item;
  ...
  item.portrait = rpgx.projectDir() + "/images/icons/P_Green02.png";
